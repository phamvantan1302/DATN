...
<head>
    ...
    <style>
        ...
        body{
            background: url("/views/giay-20.jpg");
...
<body >
<div id="wrapper" class="home_content" ng-app="myApp" ng-controller="loginController">
    <form action="" id="form-login">
        <h2 class="form-heading">Adidas Sport</h2>
        <div class="form-group">
            <i class="far fa-user"></i>
            <input type="email" id="loginUsername" name="loginUsername" class="form-input" placeholder="Email">
        ...
        <input type="button" onclick="validateLogin()" ng-click="login()" value="Login"  class="form-submit">
...
app.controller('loginController', function($scope, $http) {
    $scope.login = function() {
        ...
        $http.post('http://localhost:8080/AdidasSporst/login', { username: loginUsername, password: loginPassword})
            .then(function(response) {
                Swal.fire({
                    ...
                    // Sau khi thông báo biến mất, chuyển hướng đến trang mới
                    window.location.href = response.data.redirectUrl;
                });
            })
            .catch(function(error) {
                // Xử lý phản hồi từ server khi đăng nhập thất bại
